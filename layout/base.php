        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="/stocks.php" class="nav-link <?= ($currentPage === 'stocks') ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="/alerts.php" class="nav-link <?= ($currentPage === 'alerts') ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="/finances.php" class="nav-link <?= ($currentPage === 'finances') ? 'active' : '' ?>">
